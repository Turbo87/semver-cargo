...
test('eq', () => {
  expect(version('1.2.3').eq(version('1.2.3'))).toBe(true);
  expect(version('1.2.3-alpha1').eq(version('1.2.3-alpha1'))).toBe(true);
  expect(version('1.2.3+build.42').eq(version('1.2.3+build.42'))).toBe(true);
  expect(version('1.2.3-alpha1+42').eq(version('1.2.3-alpha1+42'))).toBe(true);
});

test('ne', () => {
  expect(version('0.0.0').eq(version('0.0.1'))).toBe(false);
  expect(version('0.0.0').eq(version('0.1.0'))).toBe(false);
  expect(version('0.0.0').eq(version('1.0.0'))).toBe(false);
  expect(version('1.2.3-alpha').eq(version('1.2.3-beta'))).toBe(false);
  expect(version('1.2.3+23').eq(version('1.2.3+42'))).toBe(false);
});
